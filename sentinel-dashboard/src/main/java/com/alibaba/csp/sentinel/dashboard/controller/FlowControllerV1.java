...
public class FlowControllerV1 {
    ...
    public Result<List<FlowRuleEntity>> apiQueryMachineRules(@RequestParam String app,
        ...
        try {
            ...
            List<FlowRuleEntity> rules = ruleProvider.getRules(app); // 改为 ruleProvider 从 nacos 获取
    ...
    public Result<FlowRuleEntity> apiAddFlowRule(@RequestBody FlowRuleEntity entity) {
        ...
        try {
            ...
            // 把规则发布到 nacos
            List<FlowRuleEntity> rules = repository.findAllByApp(entity.getApp());
    ...
    public Result<Long> apiDeleteFlowRule(Long id) {
        ...
        try {
            // 把规则发布到 nacos
            List<FlowRuleEntity> rules = repository.findAllByApp(oldEntity.getApp());
